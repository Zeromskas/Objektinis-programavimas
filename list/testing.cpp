...
int main()
{
    ...
    {
        if(filename == "studentai1k.txt") i=0;
        else if(filename == "studentai10k.txt") i=1;
        else if(filename == "studentai100k.txt") i=2;
        else if(filename == "studentai1M.txt") i=3;
        else if(filename == "studentai10M.txt") i=4;
    ...
    cout<<"|      list1       | **1k**    | **10k**  | **100k** | **1M** | **10M** |"<<endl;
    cout<<"|------------------|-----------|----------|----------|--------|---------|"<<endl;
